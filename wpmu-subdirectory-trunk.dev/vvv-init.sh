...
if [[ ! -d /srv/www/wpmu-subdirectory-trunk ]]; then
	...
	wp core config --dbname=wpmu_subdirectory_trunk --dbuser=wp --dbpass=wp --extra-php --allow-root <<PHP
...
PHP
	...
	wp core multisite-install --allow-root --url=wpmu-subdirectory-trunk.dev --title="WPMU Subdirectory Trunk Dev" --admin_name=admin --admin_email="admin@local.dev" --admin_password="password" --allow-root

	# Create sites 2-9
	wp site create --allow-root --slug=site2 --title="WPMU Subdirectory Trunk (2)" --email="admin@local.dev" --allow-root
	wp site create --allow-root --slug=site3 --title="WPMU Subdirectory Trunk (3)" --email="admin@local.dev" --allow-root
	wp site create --allow-root --slug=site4 --title="WPMU Subdirectory Trunk (4)" --email="admin@local.dev" --allow-root
	wp site create --allow-root --slug=site5 --title="WPMU Subdirectory Trunk (5)" --email="admin@local.dev" --allow-root
