...
if [[ ! -d /srv/www/wpmu-subdomain-trunk ]]; then
	...
	wp core config --dbname=wpmu_subdomain_trunk --dbuser=wp --dbpass=wp --extra-php --allow-root <<PHP
...
PHP
	...
	wp core multisite-install --allow-root --url=wpmu-subdomain-trunk.dev --subdomains --title="WPMU Subdomain Trunk Dev" --admin_name=admin --admin_email="admin@local.dev" --admin_password="password" --allow-root

	# Create sites 2-9
	wp site create --allow-root --slug=site2 --title="WPMU Subdomain Trunk (2)" --email="admin@local.dev" --allow-root
	wp site create --allow-root --slug=site3 --title="WPMU Subdomain Trunk (3)" --email="admin@local.dev" --allow-root
	wp site create --allow-root --slug=site4 --title="WPMU Subdomain Trunk (4)" --email="admin@local.dev" --allow-root
	wp site create --allow-root --slug=site5 --title="WPMU Subdomain Trunk (5)" --email="admin@local.dev" --allow-root
